...
Les services sont déployés 5 à 10 fois par semaine avec link::https://www.terraform.io/[Terraform] et link::https://www.ansible.com/[Ansible] et servent _100 millions_ de requêtes par jour avec un _uptime_ de 100%.

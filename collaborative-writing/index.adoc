...
Les outils comme _Google Docs_ sont jugés satisfaisants pour collaborer et gérer les permissions (accès, modifications) mais peu satisfaisants dans le format de stockage et la réutilisation du contenu.

Les outils comme _GitHub_ ou _GitBook_ sont jugés satisfaisants pour l'ubiquité du stockage et la versatilité des formats de contenus mais peu satisfaisants pour la collaboration (interfaces techniques, pertes de données, difficile de commenter).
...
<rephraser la suite pour mieux souligner les choix d'interop qui feront émerger les outils>

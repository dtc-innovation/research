...
Les outils de collaboration comme _Google Docs_ sont jugés satisfaisants pour collaborer et gérer les permissions (collaboration, partage) mais peu satisfaisants dans le format de stockage et la réutilisation du contenu.

Les outils de collaboration comme _GitHub_ ou _GitBook_ sont jugés satisfaisants pour l'ubiquité du stockage et la versatilité des formats de contenus mais peu satisfaisants pour la collaboration (interfaces techniques, pertes de données, difficile de commenter).
...
Netlify CMS::
Générateur de sites Jekyll::
Synchronisation GitBook::
